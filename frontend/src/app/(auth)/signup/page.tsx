        ...
        <div style={{ backgroundColor: 'var(--color-bg-page)', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px', fontFamily: '"Inter", sans-serif' }}>
            ...
            >
                <div style={{ textAlign: 'center' }}>
                    <h1 style={{ fontFamily: '"DM Sans", sans-serif', color: 'var(--color-text-primary)', fontSize: '28px', fontWeight: 700, margin: '0 0 8px 0' }}>Create Account</h1>
                    <p style={{ color: 'var(--color-text-secondary)', fontSize: '15px', margin: 0 }}>Enter your details to register.</p>
                </div>
                ...
                <form onSubmit={handleSignup} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                        <label style={{ color: 'var(--color-text-body)', fontSize: '14px', fontWeight: 500 }}>Username</label>
                        <div style={{
                            display: 'flex',
                            alignItems: 'center',
                            border: '1px solid var(--color-border-base)',
                            ...
                            <User size={18} style={{ color: 'var(--color-text-muted)', marginRight: '10px' }} />
                            <input
                                type="text"
                                value={name}
                                onChange={(e) => setName(e.target.value)}
                                placeholder="Harshit Patil"
                                style={{
                                    flex: 1,
                                    border: 'none',
                                    outline: 'none',
